...
const AstroChristmasBackground: React.FC<{ children: React.ReactNode }> = ({ children }) => {
                ...
                <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <svg width="200" height="300" className="opacity-40">
                        <g stroke="white" strokeWidth="1">
                            <line x1="100" y1="20" x2="50" y2="100" />
                            <line x1="100" y1="20" x2="150" y2="100" />
                            <line x1="50" y1="100" x2="150" y2="100" />
                            <line x1="75" y1="100" x2="25" y2="180" />
                            <line x1="125" y1="100" x2="175" y2="180" />
                            <line x1="25" y1="180" x2="175" y2="180" />
                            <line x1="80" y1="180" x2="80" y2="280" />
                            <line x1="120" y1="180" x2="120" y2="280" />
                            ...
                            <circle cx="25" cy="180" r="2" fill="white" />
                            <circle cx="175" cy="180" r="2" fill="white" />
                            <circle cx="80" cy="280" r="2" fill="white" />
                            <circle cx="120" cy="280" r="2" fill="white" />
                            <circle cx="175" cy="180" r="2" fill="white" />
                        </g>
                    </svg>
                </div>
...
style.textContent = `
                ...
                @keyframes snowfall {
                                0% { transform: translateY(-30vh) translateX(0); } /* Start above the top */
